...
<html>
  <head>
    ...
    <title><?=$title?></title>
    <meta name="author" content="Billion Cash">
                    ...
                    <div class="container-xl wide-lg">
                        <div class="nk-content-body">
                           <div class="nk-block-head-content">
                               ...
                               <h5 class="nk-block-title fw-normal">All Withdraw Pending</h5>
                                     ...
                                     <table class=" nk-tb-list nk-tb-ulist" id="dataTables" data-auto-responsive="false">
                                         ...
                                         <thead style="line-height:3.65rem">
                                             <tr class="nk-tb-item nk-tb-head">
                                                 ...
                                                 <th class="nk-tb-col tb-col-md"><span class="sub-text">ID</span></th>
                                         ...
                                         <tbody>
                                          <?php
                                          $totalWd =0;
                                          foreach ($usr_wd as $row ) {
                                            $users = $this->model_app->view_where('users', array('username' => $row['username']))->row_array();
                                             $totalWd += $row['amount'];
                                           ?>
                                             ...
                                             <tr class="nk-tb-item">
                                                 ...
                                                 <td class="nk-tb-col tb-col-md">
                                                     <span class="tb-lead "><?= $users['full_name'];?></span>
                                                 </td>
                                                 
                                             
                                                 <td class="nk-tb-col tb-col-md">
                                                     <span class="tb-lead ">IDR <?= format_rupiah($row['amount']);?></span>
                                                 </td>
                                                  <td class="nk-tb-col tb-col-md">
                                                    <?php
                                                    if ($row['status']=='Success'){ $status = '<span class="tb-status text-success">Success</span>'; 
                                                 ...
                                                 <td class="nk-tb-col nk-tb-col-tools">
                                                     <ul class="nk-tb-actions gx-1">
                                                      <li class="nk-tb-action-hidden">
                                                          <a href="#" class="btn btn-icon" data-toggle="modal" data-target="#modalZoom" >
                                                             ...
                                                             <div class="drodown">
                                                                 ...
                                                                 <div class="dropdown-menu dropdown-menu-right">
                                                                     <ul class="link-list-opt no-bdr">
                                                                         <li><a href="<?php echo base_url();?>home/det_withdraw/<?php echo $row['id_wd'];?>"><em class="icon ni ni-focus"></em><span>Detail</span></a></li>
                                                                         <li><a href="#"><em class="icon ni ni-pen"></em><span>Edit</span></a></li>
                                                                         
                                                                         <li><a href="<?php echo base_url();?>home/delete_wd/<?php echo $row['id_wd'];?>"><em class="icon ni ni-cross"></em><span>Delete</span></a></li>
                                         ...
                                         <h4 style="margin-top: 30px" >Total WD : Rp. <?= format_rupiah(@$totalWd);?></h4>
                                  </div>
                                </div>
                              </div>
                            </div>
