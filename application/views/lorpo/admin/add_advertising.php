...
<html>
  <head>
    ...
    <title><?=$title?></title>
    <meta name="author" content="Y2Cash">
    ...
    <link id="skin-default" rel="stylesheet" href="<?php echo base_url(); ?>assets/backend/admin/css/theme.css?ver=1.4.0">
     ...
     <script src="<?php echo base_url(); ?>assets/backend/admin/ckeditor/ckeditor.js"></script>

    <script src="<?php echo base_url(); ?>assets/backend/admin/ckeditor/samples/js/sample.js"></script>
    
    <link  rel="stylesheet" href="<?php echo base_url(); ?>assets/backend/admin/ckeditor/css/samples/css/samples.css">
    
    <link  rel="stylesheet" href="<?php echo base_url(); ?>assets/backend/admin/ckeditor/samples/toolbarconfigurator/lib/codemirror/neo.css">
                    ...
                    <div class="container-xl wide-lg">
                        <div class="nk-content-body">
                           <div class="nk-block-head-content">
                               ...
                               <h5 class="nk-block-title fw-normal">Add Advertising</h5>
                                            ...
                                            <div class="card-inner" style="padding-bottom: 40px" >
                                              ...
                                              <div class="col-sm-6">
                                                     ...
                                                     <?php 
                                                        ...
                                                        echo form_open_multipart('home/add_advertising');?>
                                    ...
                                    <div class="col-sm-6">                                                         
                                      ...
                                      <div class="form-control-wrap">
                                          <div class="form-icon form-icon-left">
                                            ...
                                            <input type="text" name="date" class="form-control date-picker" data-date-format="yyyy-mm-dd" required>
                                            </div>
