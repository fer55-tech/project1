                    ...
                    <div class="container-xl wide-lg">
                        <div class="nk-content-body">
                           <div class="nk-block-head-content">
                               ...
                               <h5 class="nk-block-title fw-normal">All Users Active</h5>
                                           ...
                                           ?>
                                             ...
                                             <tr class="nk-tb-item">
                                                 ...
                                                 <td class="nk-tb-col tb-col-md">
                                                     <span class="tb-lead "><?= $depo['package_name'];?></span>
                                                 </td>
                                                  ...
                                                  <td class="nk-tb-col tb-col-md">
                                                    ...
                                                    <?php
                                                    if ($depo['status']=='Active'){ $status = '<span class="tb-status text-success">Active</span>'; 
                                                   }else if($depo['status']=='Pending'){ $status = '<span class="tb-status text-warning">Pending</span>';
                                                    }else{
                                                             ...
                                                             <div class="drodown">
                                                                 ...
                                                                 <div class="dropdown-menu dropdown-menu-right">
                                                                     <ul class="link-list-opt no-bdr">
                                                                         <li><a href="<?php echo base_url();?>home/det_user/<?php echo $row['id'];?>"><em class="icon ni ni-focus"></em><span>Detail</span></a></li>

                                        <li><a href="#"><em class="icon ni ni-pen"></em><span>Edit</span></a>
                                        </li>
                                                                         
                                        <li><a href="<?php echo base_url();?>home/delete_users/<?= $row['id'];?>" onclick="return confirm('Are you sure delete this data ?')" ><em class="icon ni ni-cross"></em><span>Delete</span></a></li>
